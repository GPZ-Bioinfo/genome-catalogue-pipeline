        ...
        saveAs: {
            filename -> {
                ...
                if ( is_rep && ( output_file.extension == "faa" || output_file.extension == "fna" ) ) {
                    return "species_catalogue/${cluster_prefix}/genome/${genome_name}.${output_file.extension}";
        ...
        saveAs: {
            filename -> {
                ...
                if (output_file.extension == "fna") {
                    return "additional_data/${prefix}_genomes/${fasta.baseName}.${output_file.extension}";
                }
                return null;
            }
        },
