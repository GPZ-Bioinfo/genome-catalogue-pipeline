            ...
            if line.startswith("#query"):
                ...
                if rep_protein in clusters.keys():
                    for member_protein in clusters[rep_protein]:
                        ...
                        ann_result.setdefault(genome, list()).append(
                            line.replace(rep_protein, member_protein)
                        )
...
def parse_args():
    ...
    parser.add_argument(
        "-i", "--ips", required=True, help="Path to the interproscan input file"
    )
    parser.add_argument(
        "-e", "--eggnog", required=True, help="Path to the eggNOG input file"
    )
    parser.add_argument(
        "-r",
        "--rep-list",
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Path to the tsv file generated by MMseqs that contains information on"
            " protein clusters"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-c", "--cores", required=True, type=int, help="Number of cores to use"
    )
