...
# change txt to tsv add add calculate each cluster genome counts
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        with open(
            os.path.join(args.output_folder, "clusters_split.tsv"), "w"
        ) as split_file:
            split_file.write("cluster_genomes_type\tcluster_name\tgenome_counts\tgenomes\n") # add header
